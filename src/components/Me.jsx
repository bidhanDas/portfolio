  ...
  return (
    <div id="me" className="w-full">
      <div className="max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left">
        <h2 className="text-5xl md:text-7xl tracking-wider uppercase text-blue-500 font-bold">me</h2>
        ...
        <div className="flex items-center justify-center">
          <Link href="/resume.pdf" download={true}>
            <div className="flex items-center justify-center my-8 bg-blue-500 text-white px-6 py-3 font-bold uppercase rounded-md tracking-wider cursor-pointer">
              resume 
              <span className="duration-100 ease-in -rotate-90">
